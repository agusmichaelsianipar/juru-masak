    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                  <h3 class="text-center">Create Measurement Quantity</h3>
                  <div class="col-6 mx-auto">
                  <form action="/quantity/update/{{ $quantity->id }}" method="post">
                    @csrf
                    <input type="hidden" name="_method" value="patch" />
                    <div class="mb-3">
                        <label for="quantity" class="form-label">Name</label>
                        <input type="number" class="form-control" id="quantity" name="quantity" value="{{ $quantity->quantity }}">
                        @error('quantity')
